...
This module should take around 30-40 minutes to finish.
If you finish the all module early, you can check the optional steps, otherwise you can check them later.
If you get stuck or spend too much time, you can look the solutions off every step.
...
## Step 2: adding the Spring Security dependency and login (~5 minutes)
...
## Step 3: make the `/` page public (~10 minutes)
...
## Step 4: enable form login (~3 minutes)
...
## Step 4b: add multiple users (~3 minutes)
...
Add two users, `inanc` and `yagiz`, by following the
...
<summary>📖 Add `inanc` and `yagiz` users</summary>
...
## Step 5: display the username (~2 minutes)
...
## Step 6: support different authentication schemes (~3 minutes)

We have implemented form login, with two users. We have authentication and authorization. One
...
search on the web will bring up many good introductions. (You can watch this [Devoxx Belgium 2023](https://www.youtube.com/watch?v=wP4TVTvYL0Y)).
...
### Step 6 b:Using Dex, locally (~5 minutes)
...
### (Option 2) Using an online service
...
## Step 7: Displaying the user's e-mail when logging in with SSO (~3 minutes)
